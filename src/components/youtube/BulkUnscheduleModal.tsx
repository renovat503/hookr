        ...
        <div className="space-y-4 p-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1.5">
              <label htmlFor="yt-bulk-unschedule-from" className="text-sm font-medium">
                From
              </label>
              <input
                id="yt-bulk-unschedule-from"
                type="date"
                value={fromDateIso}
            ...
            <div className="space-y-1.5">
              <label htmlFor="yt-bulk-unschedule-to" className="text-sm font-medium">
                To
              </label>
              <input
                id="yt-bulk-unschedule-to"
                type="date"
                value={toDateIso}
